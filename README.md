...
With no custom arguments, **Run demo** executes the built-in enforcement probe and **Run tests** compiles the project, runs the complete unit suite, and verifies the probe's JSON result.
